...
const MultiSelectorTrigger = (({ className, children, ...props }, ref) => {
...
const MultiSelectorInput = (({ className, ...props }, ref) => {
    const {
        setOpen,
        inputValue,
        setInputValue,
...
const MultiSelectorContent = (({ children }, ref) => {
...
const MultiSelectorList = (({ className, children }, ref) => {
    return (
        <CommandList
            ref={ref}
            className={cn(
...
const MultiSelectorItem = (({ className, value, children, ...props }, ref) => {
